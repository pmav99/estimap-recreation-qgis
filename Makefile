...
# EstimapRecreation
#
# Ecosystem services mapping at European scale (ESTIMAP)- Recreation
#							 -------------------
#		begin				: 2019-02-08
#		git sha				: $Format:%H$
...
SOURCES = \
	__init__.py \
	estimap_recreation.py

PLUGINNAME = estimap_recreation
...
QGISDIR=/home/feanor/.local/share/QGIS/QGIS3/profiles/default/python/plugins/
